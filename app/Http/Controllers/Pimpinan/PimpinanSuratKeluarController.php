...
class PimpinanSuratKeluarController extends Controller
{
    public function index(){
        ...
        return view('pimpinan/surat_keluar.index',compact('surat_keluars'));
    }

    public function add(){
        $jenissurat = JenisSurat::select('id','jenisSurat')->get();
        return view('pimpinan/surat_keluar.add',compact('jenissurat'));
    }
    ...
    public function post(Request $request){
        ...
        return redirect()->route('pimpinan.surat_keluar')->with($notification);
    }
    ...
    public function edit($id){
        ...
        return view('pimpinan/surat_keluar.edit',compact('data','jenissurat'));
    }
