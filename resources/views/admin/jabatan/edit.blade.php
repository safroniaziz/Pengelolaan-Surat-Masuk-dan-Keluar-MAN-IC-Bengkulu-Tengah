    ...
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <div class="row">
                    <form action="{{ route('admin.jabatan.update',[$data->id]) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" name="nm_jabatan" value="{{ $data->namaJabatan }}" class="tags form-control @error('nm_jabatan') is-invalid @enderror" />
                                <div>
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" name="keterangan" value="{{ $data->keterangan }}" class="tags form-control @error('keterangan') is-invalid @enderror" />
                                <div>
