...
<html>
	<head>
		<meta charset="utf-8">
        <title>Simas MAN IC | Login</title>
		...
		<div id="particles-js">
            <div class="loginBox">
                ...
                @if ($errors->any())
                    ...
                    @else
                    <h6>Form Login</h6>
                    <p style="text-align:center; margin-bottom:20px;">Sistem Informasi Manajemen Surat <br> MAN IC Bengkulu Tengah</p>
                @endif
                <form method="post" action="{{ route('login') }}">
                    @csrf
                    <p>Nomor Induk Kepegawaian</p>
                    <input type="text" value="{{ old('nip') }}" name="nip" placeholder="masukan nip">
                    <p>Password</p>
